# (Warning: post-WIP, rough) Update default branches on forked GitHub repos
# with an option to filter on projects for a specific Puppet forge org
#
# Adjust target repos using the allow_list/block_list in the github_inventory plugin
#
# @param targets
...
#
plan releng::github_update_pupmod_forks(
